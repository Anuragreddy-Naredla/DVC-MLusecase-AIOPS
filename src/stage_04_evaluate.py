...
def evaluate_metrics(actual_values, pred_values):
    mse = np.sqrt(mean_squared_error(actual_values, pred_values))
...
def evaluate(config_path, params_path):
    ...
    save_reports(report=scores, reports_path=scores_filepath)
